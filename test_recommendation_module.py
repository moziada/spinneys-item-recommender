...
def test_fit():
    ...
    df = pd.DataFrame({
        ...
        "Subgroup": ["1", "1", "1", "1", "1", "1", "1"]}, dtype="category")
    model.record_items_subgroup(df, "Item No_", "Subgroup")
...
def test_partial_fit():
    ...
    df1 = pd.DataFrame({
        ...
        "Subgroup": ["1", "1", "1", "1"]}, dtype="category")
    
    df2 = pd.DataFrame({
        "Receipt No_": ["101", "101"],
        "Item No_": ["11", "10"],
        "Subgroup": ["1", "1"]}, dtype="category")

    df3 = pd.DataFrame({
        "Receipt No_": ["102"],
        "Item No_": ["10"],
        "Subgroup": ["1"]}, dtype="category")
